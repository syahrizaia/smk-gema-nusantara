...
const dataPembelajaran = {
    dataImage: [
        {
            id: 1,
            src: "https://smkgemanusantara.sch.id/wp-content/uploads/2023/05/kurikulum.png"
        }
    ]
}
    ...
    tableBody: [
        {
            id: 1,
            no: 1,
            achievementsAchieved: "Bekerja sama dengan berbagai industri industri",
            year: "2023",
        },
        {
            id: 2,
            no: 2,
            achievementsAchieved: "Lulusan diterima di perguruan tinggi negeri dan swasta",
            year: "2023",
        },
        {
            id: 3,
            no: 3,
            achievementsAchieved: "Lulusan terserap di dunia industri",
            year: "2023",
        },
        {
            id: 4,
            no: 4,
            achievementsAchieved: "Lulusan terserap di dunia usaha",
            year: "2023",
        },
        {
            id: 5,
    ...
    dataContent: [
        {
            id: 1,
            title: "Angkatan 63",
            image1: "https://smkgemanusantara.sch.id/wp-content/uploads/2023/05/serapan-lulusan20-22.png",
            image2: "https://smkgemanusantara.sch.id/wp-content/uploads/2023/05/lulusan63.png"
        }
    ]
}

const dataHubungiKami = {
    dataSekolah: [
        {
            id: 1,
            title: "Data Sekolah Kita",
            kepsek: "Gumilang Agung Laksono",
            operator: "Dewi Larasati Indah Purnama",
            akreditasi: "A",
    ...
    identitasSekolah: [
        {
            ...
            SKPendirianSekolah: "8",
            tanggalSKPendirian: "2005-11-28",
            SKIzinOperasional: "503.15/06/II/SK-SMK/BPMPPT/2016",
            tanggalSKIzinOperasional: "2016-02-15",
        }
    ],
    kontakUtama: [
        {
            id: 1,
            title: "Kontak Utama",
            alamat: "JL. Raya Cibarusah, Warung Bambu",
            email: "mail@smkgemanusantara.sch.id",
            RTRW: "2/3",
            dusun: "Sindangmulya",
            desakelurahan: "Sindangmulya",
            kecamatan: "Kec. Cibarusah",
